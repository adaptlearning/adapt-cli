...
// TODO: api, console and error output
// TODO: api, update / install / uninstall return values
...
class API {
  ...
  async buildCourse ({
    ...
    // TODO: make sure this https://github.com/adaptlearning/adapt_framework/pull/3278 goes in
    await build({
      sourceMaps,
      checkJSON,
      cache,
  ...
  async getSchema ({
    ...
    // TODO: check that the caching is acceptable here
