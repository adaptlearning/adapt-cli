...
function setMainEntryPoint(properties) {
    console.log(properties)
    var match = (/"main": "\w*"/g),
        replacement = '"main":"js/adapt-' + properties.component.name + '.js"';

    return replaceTextContent(properties.component.files[0], match, replacement).then(properties);
}