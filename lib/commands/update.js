...
module.exports = function() {
    ...
    function createPlugins() {
        ...
        return Q.all(plugins.map(getInfo)).progress(function() {
                var settled = plugins.filter(function(plugin) {return plugin._bowerInfo || plugin._isMissing;}).length;
    ...
    function renderUpdateProgress() {
        var list = plugins.filter(function(plugin) {return !plugin._isMissing && plugin._shouldBeUpdated});
